	  ...
	  protected void configure(HttpSecurity http) throws Exception {
	    http.cors().and().csrf().disable()
	      ...
	      .authorizeRequests().antMatchers("/api/auth/**").permitAll()
				...
				.antMatchers("/adress/**").permitAll()
				.antMatchers("/etatpaie/**").permitAll()
				.antMatchers("/grppret/**").permitAll()
				.antMatchers("/libredeman/**").permitAll()
				.antMatchers("/pays/**").permitAll()
				.antMatchers("/personnel/**").permitAll()
				.antMatchers("/services/**").permitAll()
				.antMatchers("/api/societes/**").permitAll()
				.antMatchers("/soldcng/**").permitAll()
				.antMatchers("/typeorg/**").permitAll()
